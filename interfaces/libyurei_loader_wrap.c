...
/*-----------------------------------------------
              @(target):= _libyurei_loader.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__libyurei_loader

#else
#  define SWIG_init    init_libyurei_loader

#endif
#define SWIG_name    "_libyurei_loader"
...
SWIGINTERN PyObject *_wrap_obj_model_name_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  else memset(arg1->name,0,56*sizeof(char));
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_obj_model_vertices_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  struct obj_model *arg1 = (struct obj_model *) 0 ;
  struct obj_vertex *arg2 = (struct obj_vertex *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  void *argp2 = 0 ;
  int res2 = 0 ;
  ...
  arg1 = (struct obj_model *)(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_obj_vertex, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "obj_model_vertices_set" "', argument " "2"" of type '" "struct obj_vertex *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_obj_model_vertices_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = (struct obj_model *)(argp1);
  result = (struct obj_vertex *) ((arg1)->vertices);
